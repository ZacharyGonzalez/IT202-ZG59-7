...
<tr><td> <em>Generated: </em> 10/6/2024 3:38:04 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-AR451-M2024/it202-m2-php-hw/grade/zg59" target="_blank">Grading</a></td></tr></table>
...
<table><tr><td> <em>Deliverable 1: </em> Problem 1 - Only output Odd values of the Array under "Odds output" </td></tr><tr><td><em>Status: </em> <span style="color: green;">COMPLETED </td></tr>
...
<tr><td><table><tr><td><img width="100" height="20" src="https://github.com/Venrite/IT202-ZG59-7/blob/main/HW2/php1b.png"><img width="100" height="20" src="https://github.com/Venrite/IT202-ZG59-7/blob/main/HW2/php1.png"></td></tr>
<tr><td> <em>Caption:</em> The Code is simple and so is the output</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>we just went through the array and if it was divisible by 2 it was even, if it had a remainder then we echo'd it as it was odd. </p><br></td></tr>
</table></td></tr>
<table><tr><td> <em>Deliverable 2: </em> Problem 2 - Only output the sum/total of the array values by assigning it to the $total variable (the number must end in 2 decimal places, if it ends in 1 it must have a 0 at the end) </td></tr><tr><td><em>Status: </em> <span style="color: green;">COMPLETED</td></tr>
...
<tr><td> <em>Caption:</em> Simple code simple output, just total them up, ad pray floating point arithmetic doesnt screw up the values </td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>total would add the value selected to its current amount and then equal itself to the new totaled value. do this for each value before rounding, also reset to 0 after each for loop.</p><br></td></tr>
</table></td></tr>
<table><tr><td> <em>Deliverable 3: </em> Problem 3 - Output the given values as positive under the "Positive Output" message (the data otherwise shouldn't change) </td></tr><tr><td><em>Status: </em> <span style="color: green;">COMPLETED </td></tr>
...
<tr><td> <em>Caption:</em> just do a check on string and convert else its an int</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
...
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-AR451-M2024/it202-m2-php-hw/grade/zg59" target="_blank">Grading</a></td></tr></table>
